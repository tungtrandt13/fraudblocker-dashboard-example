...
const PersonalDetailsForm = ({
        ...
        const savePersonalDetails = async () => {
            ...
            try {
                ...
                if (result) {
                    ...
                    if (personalDetails.timezone.value) {
                        moment.tz.setDefault(personalDetails.timezone.value.substr(personalDetails.timezone.value.indexOf(') ') + 2));
                    }
        ...
        const handleAdFraudChange = option => {
            if (personalDetails.ad_frauds.includes(option)) {
                ...
                setPersonalDetails(pre => ({ ...pre,
                    ad_frauds: updatedFraud.join('_')
                }));
            } else {
                setPersonalDetails(pre => ({ ...pre,
                    ad_frauds: `${pre.ad_frauds}_${option}`
                }));
            }
        };
        ...
        return ( <
            div className = {
                `${styles.slideLeft} ${styles.active}`
            } >
            <
            h2 >
            ...
            div className = {
                styles.label
            } > What & apos; s your timezone < span > (you can change this later) < /span>?</div >
            <
            Dropdown options = {
                allTimezones.values
            }
            onOptionChange = {
                val => onOptionChange('timezone', val)
            }
            containerStyle = {
            ...
            div className = {
                ...
                AD_FRAUDS_OPTIONS.map(option => ( <
                    ...
                    checked = {
                        personalDetails.ad_frauds.includes(option)
                    }
                    onChange = {
                        () => handleAdFraudChange(option)
                    }
                    /> <
                    label > {
                        option
            ...
            div className = {
                styles.label
            } > Where do you advertise most ? < /div> <
                div className = {
                    styles.multiCheckbox
                } >
                <
            ...
            value = "Google Ads"
            checked = {
                personalDetails.advertise_platform === 'Google Ads'
            }
            onChange = {
                handleInput
            }
            ...
            value = "Facebook Ads"
            checked = {
                personalDetails.advertise_platform === 'Facebook Ads'
            }
            onChange = {
                handleInput
            }
            ...
            /div> <
            /div> {
                errors.apiError && < ErrorBox error = {
                    errors.apiError
                }
                />} <
                div className = {
