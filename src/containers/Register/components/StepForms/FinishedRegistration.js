    ...
    render() {
        ...
        return (
            <div className={styles.formContainer}>
                <img src={CONGRATS} className={styles.congoLogo} alt="congratulations" />
                ...
                {!error && (
                    <>
                        <h3>
                            <img src={SPARKEL} alt="sparkel" />
                            Your 7 - day trial has started{" "}
                        </h3>{" "}
                        <p className={styles.accountCreatedText}>
                            To start blocking click fraud, simply install our Fraud Tracker pixel and connect your ad
                            accounts.{" "}
                        </p>{" "}
