...
const CompanyDetailsForm = ({
        ...
        return ( <
            ...
            for an ad agency(manage multiple clients) ? < /div> <
            div className = {
            ...
            value = "Yes"
            checked = {
                companyDetails.work_for_agency === 'Yes'
            }
            onChange = {
                handleInput
            }
            ...
            value = "No"
            checked = {
                companyDetails.work_for_agency === 'No'
            }
            onChange = {
                handleInput
            }
            ...
            div className = {
                styles.label
            } > Number of employees at your company < /div> <
            div className = {
                styles.selectBox
            } >
            <
            ...
            value = {
                EMPLOYEE_OPTIONS.find(item => item.value === companyDetails.number_of_employees)
            }
            selectClass = {
                styles.select
            }
            ...
            div className = {
                styles.label
            } > What is your typical spend in PPC advertising each month ? < /div> <
            div className = {
                styles.selectBox
            } >
            <
            ...
            value = {
                PPC_ADS_OPTIONS.find(item => item.value === companyDetails.spend_in_ppc_ads)
            }
            selectClass = {
                styles.select
            }
