...
class FinishedRegistration extends PureComponent {
    ...
    render() {
        ...
        return ( <
            ...
            h1 className = {
                styles.headerText
            } > Woot!Congratulations. < /h1> <
            div className = {
                styles.finishedImageContainer
            } >
            <
            img src = {
                FINISHED
            ...
            /div> {
                ...
                />} {
                    ...
                    !this.state.loading && !error && ( <
                        ...
                        To start blocking fraud simply follow the instructions to install the Fraud Blocker monitoring pixel on your website. <
                        /p>
                    )
                } {
                    !this.state.loading && !error && ( <
