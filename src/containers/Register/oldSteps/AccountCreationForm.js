...
function AccountCreationForm({
    ...
    const { selectedPlan, selectedBilling, loading, billingOptions, errors, proClicks, currency } = formState;
    ...
    return (
        <div className={styles.formContainer}>
            ...
            {(errors.accountCreation || couponError) && (
                <ErrorBox errorStyle={{ marginRight: "35px" }} error={errors.accountCreation || couponError} />
            )}
