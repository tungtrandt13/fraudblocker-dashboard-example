...
function AccountExistModal({
    ...
    const renderErrorMessage = () => (
        <div>
            ...
            {' '}This account already has an active plan. Please contact us.
        </div>
    );
    ...
    return (
        <Modal
            isOpen={isOpen}
            style={modalStyles}
            contentLabel="Account Exists Alert"
            ariaHideApp={false}
        >
                ...
                <div className={styles.content}>
                    <div className={styles.contentWrapper}>
                        <div className={styles.imgContain}>
                            <img 
                                src={AccountExistIcon} 
                                className={styles.icon}
                                alt="Account exists icon"
                            />
                        </div>
                        ...
                        <p className={styles.descriptionText}>
                            By pressing this button, your new AppSumo plan will be added to this account. 
                            Once completed, you will then be directed to login to begin using our services.
                        </p>

                        {state.error && (
                            <ErrorBox error={renderErrorMessage()} />
                        )}
